...
class UserProfile(TimeStampedModel, ActivatorModel, models.Model):
  ...
  class Meta:
    ...
    ordering            = ["id"]
  # atrributes
  telephone = models.CharField(verbose_name = "Telephone number", max_length =255, null=True, blank=True)
  ...
  # relaties
  user      = models.OneToOneField(User, on_delete=models.CASCADE) # als user wordt verwijderd wordt ook het gekoppelde userprofile verwijderd 
